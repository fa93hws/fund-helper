...
export const fakeValueResponseParsed = {
  values: [
    {
      time: new Date('2020-04-24T07:00:00.000Z'),
      value: 3.751,
    },
    {
      time: new Date('2020-04-23T07:00:00.000Z'),
      value: 3.795,
    },
  ],
  pages: 211,
...
export const fakeListResponseRaw = 'var r = [["000001","HXCZHH","华夏成长混合","混合型","HUAXIACHENGZHANGHUNHE"],["000002","HXCZHH","华夏成长混合(后端)","股票指数","HUAXIACHENGZHANGHUNHE"]];';
